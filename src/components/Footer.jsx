        ...
        >
          ...
          <Stack direction="row" spacing={6}>
            <Stack direction="column" spacing={3} align="flex-start">
              ...
              <Link href="#home" fontSize="sm" _hover={{ color: accentColor }}>
                Home
              </Link>
              <Link href="#projects" fontSize="sm" _hover={{ color: accentColor }}>
                Projects
              </Link>
              <Link href="#skills" fontSize="sm" _hover={{ color: accentColor }}>
                Skills
              </Link>
              <Link href="#contact" fontSize="sm" _hover={{ color: accentColor }}>
                Contact
              </Link>
            </Stack>
